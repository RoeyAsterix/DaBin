...
- [0.3.7 release notes](docs/RELEASE_NOTES_0.3.7.md)
...
Release 0.3.7 replaces the header's three-dot menu icon with a matching settings wheel and retains 0.3.6's rounded caption cards.
