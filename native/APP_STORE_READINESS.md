...
**Source version:** 0.3.13 (38), pre-publication release verification complete
...
The final 0.3.13 preflight logs are retained with the pre-publication release evidence:

- `../docs/qa/0.3.13/app-store-preflight-static-v0.3.13.log`: all 20 source and packaging checks passed.
- `../docs/qa/0.3.13/app-store-preflight-release-v0.3.13.log`: release preflight remains blocked by the Apple Developer Team ID and full Xcode. The configured GitHub policy/support URLs pass offline syntax checks; their content and continuing reachability remain owner responsibilities.
