...
**Source version:** 0.3.15 (40), direct release checks passed
...
The completed 0.3.14 evidence, its live Settings-only gap, and the completed 0.3.15 publication and installed-app verification are recorded in `QA_RESULTS.md`.
