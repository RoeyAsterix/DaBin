...
Release 0.3.17 adds a complete **Quit DaBin** action to Settings and verifies that accepted termination stops every background capture monitor. All 30 optimized Release suites and 50 release renders passed. The release publishes the same verified ARM64 app in both a one-click installer/update package and a separate manual Apple Silicon package.
