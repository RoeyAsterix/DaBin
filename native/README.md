...
Release 0.3.11 rebuilds successful Auto Capture feedback with twelve shuffled camera-island celebrations, a single rapid-capture popup and an accessibility-specific Reduced Motion sequence. It retains the Text filter, active-date Weekly layout, complete-day export, rounded caption cards and the private one-use update-document handoff. An installed 0.3.10 build can pull this release directly from Settings.
