...
Release 0.3.9 removes empty date columns from Weekly and sizes the panel to its active dates. An empty range stays compact. It retains complete-day export, the matching settings wheel, rounded caption cards, Auto Capture and the private one-use update-document handoff. An installed 0.3.8 build can pull this release directly from Settings.
