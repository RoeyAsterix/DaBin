...
- In the **gear menu → Settings → Appearance**, toggle Dark mode and adjust the board transparency from 35% to 100% opacity. Under **Theme color**, choose Purple, Blue, Teal, Green, Rose or Amber, or pick a custom color. Changes apply immediately and are remembered on this Mac. **Reset** returns the accent to Purple. When macOS Reduce Transparency is enabled, DaBin temporarily uses a solid surface and explains the override in Settings.
